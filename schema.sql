--
-- File generated with SQLiteStudio v3.4.17 on Fri Mar 20 17:47:33 2026
--
...
-- Table: events
CREATE TABLE IF NOT EXISTS events (event_id INTEGER PRIMARY KEY ASC AUTOINCREMENT UNIQUE NOT NULL, device INTEGER REFERENCES devices (device_id) NOT NULL, report TEXT CHECK (json_valid(report)), full_image_path TEXT, cell_image_path TEXT, sound_path TEXT, event_type INTEGER REFERENCES event_types (event_type_id), timestamp TEXT NOT NULL, text TEXT);
...
-- Table: settings
CREATE TABLE IF NOT EXISTS settings (setting_id INTEGER PRIMARY KEY ASC AUTOINCREMENT UNIQUE NOT NULL, discord_webhook TEXT, profile TEXT, backlog_count INTEGER NOT NULL DEFAULT (0));
