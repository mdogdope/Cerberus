...
-- Table: children
CREATE TABLE IF NOT EXISTS children (child_id INTEGER PRIMARY KEY ASC AUTOINCREMENT, name TEXT UNIQUE NOT NULL);

-- Table: devices
CREATE TABLE IF NOT EXISTS devices (device_id INTEGER PRIMARY KEY ASC AUTOINCREMENT, device_name TEXT NOT NULL, device_ip TEXT NOT NULL UNIQUE, child TEXT REFERENCES children (child_id), settings TEXT CHECK (json_valid(settings)));
